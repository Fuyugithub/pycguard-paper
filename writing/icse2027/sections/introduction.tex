...
lack a suspicious shape. These patterns affect analysis cost only and are not
part of the obligation semantics. For each retained instance, a large language
...
\begin{itemize}
  ...
  binding and 15 pattern-based pruning rules with structured, path-oriented
