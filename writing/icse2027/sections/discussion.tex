...
interprocedural teardown helpers; the remaining 12 require richer API-semantics, control-flow
feasibility, and error-state modeling. Preprocessing selected macros,
