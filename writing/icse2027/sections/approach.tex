...
\begin{equation}
  ...
  \label{eq:discharge}
\end{equation}
Thus, different paths can satisfy different conditions. The GC lifecycle
obligation uses a conjunctive mode because allocation, tracking, traversal, clearing, and
