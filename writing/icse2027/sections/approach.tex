...
also inspect real Python/C API bug cases and their fixes. Bug cases expose
requirements that are easy to overlook in prose, interactions between
requirements, and recurring code forms suitable for pruning. The empirical
study of the Python/C API provides independent evidence that ownership,
exception, and compatibility mistakes occur in extension code
\cite{hu2020pythoncapi}.
